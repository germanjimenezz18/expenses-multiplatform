  ...
  ({ value, onChange, placeholder, disabled }, ref) => {
    ...
    return (
      <div className="relative">
        ...
        <CurrencyInput
          className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 pl-10 text-sm file:border-0 file:bg-transparent file:font-medium file:text-sm placeholder:text-muted-foreground focus-visible:outline-none disabled:cursor-not-allowed disabled:opacity-50"
          decimalScale={2}
          decimalsLimit={2}
          disabled={disabled}
