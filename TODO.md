...
- [+] periods upgrade 
    - [+] Month selector
    - [+] Custom default period selected (default to current month)
- [+] Add latest shadcn components and configuration
    - [?] Upgrade to tailwind v4 (currently on v3 for shadcn compatibility)

- [+] Add vercel AI SDK 
- [+] Sheet > input > update placeholder when changing the name and reopening the sheet
